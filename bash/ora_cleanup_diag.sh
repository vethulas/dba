...
2) Background:
   ...
   bash$ nohup /home/oracle/dba/scripts/dev/ora_cleanup_diag_DEV.sh <DIAG_DEST> <DEPTH> &

   Example:
   --------

   bash$ nohup /home/oracle/dba/scripts/dev/ora_cleanup_diag_DEV.sh /diag/19.0.0 7 &

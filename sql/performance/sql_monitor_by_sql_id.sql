--#-----------------------------------------------------------------------------------
--# File Name    : sql_monitor_by_sql_id.sql
--#
--# Description  : Shows SQL Monitor captured info about quiery using provided SQL_ID.
--#
--# Call Syntax  : SQL> @sql_monitor_by_sql_id (sql-id)
--#-----------------------------------------------------------------------------------
